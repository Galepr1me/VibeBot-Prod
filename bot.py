...
async def help_slash(interaction: discord.Interaction):
    ...
    try:
        ...
        if is_staff:
            ...
            embed.set_footer(text="🔐 Staff commands visible to Staff role only • Version 1.2.7")
        else:
            embed.set_footer(text="💡 Tip: Use /daily every day for streak bonuses! • Version 1.2.7")
